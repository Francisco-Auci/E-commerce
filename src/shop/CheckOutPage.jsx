            ...
            <div className='modal-body'>
              <div className="tabs mt-3">
                <ul className='nav nav-tabs' id='myTabs' role='tablist'>
                  <li className='nav-item' role='presetation'>
                    <a className={'nav-link ${activeTab === "visa" ? "active" : ""}'} id='visa-tab' data-toggle='tab' role='tab' aria-controls='visa' aria-selected={activeTab === "visa"} onClick={() => handleTabChance("visa")} href="#visa">
                      <img src="https://i.imgur.com/sB4jftM.png" alt="" width="80" />
                    </a>
                  </li>
                  <li className='nav-item' role='presetation'>
                    <a className={'nav-link ${activeTab === "paypal" ? "active" : ""}'} id='paypal-tab' data-toggle='tab' role='tab' aria-controls='paypal' aria-selected={activeTab === "paypal"} onClick={() => handleTabChance("paypal")} href="#paypal">
                ...
                <p className='mt-3 px-4 p-Disclaimer'><em>Payment Disclaimer:</em> In no event shall payment or partial by Owner for any material or service</p>
              </div>
            </div>
          </div>
        </div>
